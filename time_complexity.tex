...
$$
O(n_{sunion} \cdot (n_{tp}^{2} - \sum_{i=1, j=1}^{n_{qstar}}  n_{tp_{Q_{star_i}}} \cdot  n_{tp_{Q_{star_j}}})) 
$$
...
\begin{equation}
O(n_{sunion} \cdot n_{tp_{max}}^{2} \cdot n_{Q_{star_{max}}} \cdot n_{Q_{starG}}),
\end{equation}
